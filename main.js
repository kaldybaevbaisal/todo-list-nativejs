...
let detialsInner = document.getElementById("details__inner");
...
editParent.addEventListener("click", () => toggleModal("edd"));
...
detialsInner.addEventListener("click", (e) => {
  e.stopPropagation();
});
...
function taskDetails(task) {
  ...
  description.innerText`Описанние задачи-${task.description}`;
  ...
  date.innerText = `Срок задачи до-${task.date}`;
  let h1 = detialsInner.querySelector("#details-header");
